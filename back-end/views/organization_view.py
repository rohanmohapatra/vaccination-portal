...
from dataaccess.auxiliary import get_types_vaccinations, add_new_vaccination_type
...
def organization_login():
    ...
    query = get_organization(json_data["organization_id"])
...
def add_patient_vaccination_details():
	...
	if vaccination_id in vaccination_types:
		...
		add_patient_vaccination_record(patient_id,vaccination_name,vaccination_id,date_given,validity)
		return Response(status=200)
	else:
		return Response(status=401)
